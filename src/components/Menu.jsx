        ...
        <section id='menu' aria-labelledby='menu-heading'>
                    ...
                    sliderLists.map((cocktail, index) => {
                        ...
                        return (
                            <button key={cocktail.id}
                                    className={isActive ? 'text-white border-white' : `text-white/50 border-text-white/50`}
            ...
            <div className="content">
                ...
                <div className="cocktail">
                    <img alt="current-cocktail" src={currentCocktail.image} className="object-contain"/>
                </div>
